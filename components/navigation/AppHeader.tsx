...
export default function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700">
      ...
      {mobileOpen && (
        <div className="sm:hidden border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-lg">
          <div className="px-4 py-3 flex flex-col gap-3 text-sm font-semibold text-slate-700 dark:text-slate-300">
            {isLoggedIn ? (
              <>
              ...
              <>
                <Link href="/courses" onClick={() => setMobileOpen(false)} className="hover:text-slate-900 dark:hover:text-slate-100">
                  Courses
                </Link>
                <Link href="/pricing" onClick={() => setMobileOpen(false)} className="hover:text-slate-900 dark:hover:text-slate-100">
                  Pricing
                </Link>
                <Link href="/playground" onClick={() => setMobileOpen(false)} className="hover:text-slate-900 dark:hover:text-slate-100">
                  Playground
                </Link>
                <Link
                  href="/auth/login"
