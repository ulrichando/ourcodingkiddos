...
import { BookOpen, Clock, Star, ChevronRight, Loader2, Search, Users, Award } from "lucide-react";
    ...
    <InstructorLayout>
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-slate-600 dark:text-slate-400">Browse and manage coding courses</p>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredCourses.map((course) => (
              <Link
                ...
                className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 hover:shadow-lg hover:border-indigo-300 dark:hover:border-indigo-600 transition-all group"
              >
                ...
                <h3 className="font-semibold text-slate-900 dark:text-slate-100 mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                  {course.title}
                </h3>
