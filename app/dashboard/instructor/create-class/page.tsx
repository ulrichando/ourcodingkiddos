  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Create a New Class</h1>
          <p className="text-slate-600">Set up the session details and meeting link.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
                Start Time <CalendarDays className="h-4 w-4 text-slate-400" />
              </label>
              <input
                type="datetime-local"
                required
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="space-y-1">
              <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
                Duration (minutes) <Clock className="h-4 w-4 text-slate-400" />
              </label>
              <input
                type="number"
                min={15}
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
                Max Students <Users className="h-4 w-4 text-slate-400" />
              </label>
              <input
                type="number"
                min={1}
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-slate-700 flex items-center gap-2">
                Meeting Link <Video className="h-4 w-4 text-slate-400" />
              </label>
              <input
                value={meetingUrl}
                ...
                className="w-full rounded-lg border border-slate-200 px-3 py-2"
              />
              <p className="text-xs text-slate-500">Leave blank to auto-generate a Google Meet link.</p>
            </div>
          </div>
