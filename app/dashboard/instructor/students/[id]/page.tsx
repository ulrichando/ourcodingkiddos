    ...
    <main className="min-h-screen bg-slate-50">
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <Link href="/dashboard/instructor/students" className="inline-flex items-center gap-2 text-slate-600 hover:text-slate-800">
              <ArrowLeft className="h-4 w-4" />
              Back to students
            </Link>
            <h1 className="text-2xl font-bold text-slate-900 mt-2">{student.name}</h1>
            <p className="text-slate-600">Parent: {student.parentEmail || "N/A"}</p>
          </div>
        </div>
          ...
          <CardContent className="p-6 space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500">Age: {student.age ?? "N/A"}</div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-3">
              {[
                ...
                <div key={stat.label} className="flex items-center gap-2 rounded-xl bg-slate-100 px-3 py-2">
